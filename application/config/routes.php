...
// Admin Users Routes
$route['api/admin-users'] = 'api/adminusers/index';
$route['api/admin-users/(:num)'] = 'api/adminusers/show/$1';
...
$route['api/([a-zA-Z_-]+)/([a-zA-Z_-]+)'] = 'api/$1/$2';
$route['api/([a-zA-Z_-]+)/([a-zA-Z_-]+)/(:any)'] = 'api/$1/$2/$3';
